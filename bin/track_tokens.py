#!/usr/bin/env python3
"""
Token usage tracker for Paperclip budget integration.
...
Output: Appends JSON entry to ~/.paperclip/companies/ai-holding/budget-log.jsonl
...
DEFAULT_BUDGET_LOG = os.path.expanduser(
    "~/.paperclip/companies/ai-holding/budget-log.jsonl"
)
